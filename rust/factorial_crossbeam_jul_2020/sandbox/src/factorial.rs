...
pub fn find_factors<'a,'b>(chunk: &'a Chunk, factorial_worker_mutex: &'a Arc<Mutex<FactorialWorker>>) -> [Result; MAX_SIZE] {
    let mut results: [Result; MAX_SIZE] = [Result::new(); MAX_SIZE];
